define([
  ...
  'dojo/text!./templates/StructureSequencePrediction.html', './AppBase',
  ...
  return declare([AppBase], {
    baseClass: 'StructureSequencePrediction',
    templateString: Template,
    applicationName: 'StructureSequencePrediction',
    requireAuth: true,
    applicationLabel: 'Structure Sequence Prediction',
    ...
    videoLink: '',
    pageTitle: 'Structure Sequence Prediction Service | BV-BRC',
    required: true,
    code_four: false,
    defaultPath: '',
